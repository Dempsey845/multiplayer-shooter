...
var upgrade_option_scene: PackedScene = preload("uid://bt6v7r12h3qr3")
...
func _on_upgrade_option_selected(index: int, for_peer_id: int):
	handle_upgrade_selected(index, for_peer_id)
